...
<header class="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 transition-all duration-300">
  <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
    <!-- Logo -->
    <a href="/" class="flex items-center gap-2 text-xl font-bold tracking-tight text-black">
      ...
      aB Real Estate Solutions
    </a>

    <!-- Nav Links -->
    <nav class="hidden md:flex items-center gap-8">
      <a href="#services" class="text-sm font-medium text-gray-600 hover:text-black transition-colors">Services</a>
      <a href="#about" class="text-sm font-medium text-gray-600 hover:text-black transition-colors">About</a>
      <a href="#contact" class="text-sm font-medium text-gray-600 hover:text-black transition-colors">Contact</a>
    </nav>

    <!-- Right Actions -->
    <div class="flex items-center gap-6">
      <a href="tel:+4921188250138" class="hidden md:block text-sm font-medium text-gray-600 hover:text-black transition-colors">+49 211 88250138</a>
      <a href="mailto:info@aBRESolutions.de" class="text-sm font-medium text-black hover:text-primary-600 transition-colors">Get in Touch</a>
    </div>
  </div>
</header>
